...
```
<br/>
Wyżej wskazane wykresy wskazują że wydatki na wędliny dla grupy dochodowej para z dzieckiem są dobrem wyższego rzedu. W następnym kroku zostanie dopasowana funkcja.
