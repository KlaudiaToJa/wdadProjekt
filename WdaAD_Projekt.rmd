...
Na początku zosta sprawdzony typ zmiennych w kolumnach, żeby upewnić się, że sumowanie danych z wiersza będzie poprawną operacją:
...
Wykres dopiasowania funkcji Tornquista II rodzaju dla wędlin.
...
- Na drugim miekscu co do wielkości udziału w wydatkach na mięso znajdują się wydatki na wędliny. Dla pary z jednym dzieckiem jest to dobro wyższego rzędu, co oznacza, że wydatki na wędliny rosną w miarę wzrostu dochodu.
